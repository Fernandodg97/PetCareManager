      ...
      <form>
        <div class="content-container">
          ...
          <ion-item>
            ...
            <ion-input placeholder="Introduce el nombre de la mascota" aria-label="Nombre de la mascota"
          ...
          <ion-item>
            ...
            <ion-input placeholder="Describe la intervención realizada" aria-label="Descripción de la intervención"
              class="custom-input"></ion-input>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-input placeholder="Selecciona la ubicación" readonly aria-label="Ubicación del servicio"
              v-model="ubicacion" class="custom-input"></ion-input>
            <ion-button slot="end" color="primary" @click="openMap" aria-label="Seleccionar ubicación">
              Seleccionar
            </ion-button>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-input type="file" accept="application/pdf, image/*" aria-label="Subir archivo adjunto"
              class="custom-input"></ion-input>
          </ion-item>

          <!-- Botones -->
          <div class="buttons-container">
            <ion-button color="primary" expand="block" router-link="/petcaremanager/historialmedico/"
              aria-label="Guardar historial médico">
              Guardar
            </ion-button>
            <ion-button color="danger" expand="block" router-link="/petcaremanager/historialmedico/"
